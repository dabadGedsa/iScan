...
Public Class crpPeticiones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Digitalización.crpPeticiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpPeticiones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpPeticiones = New crpPeticiones
        rpt.Site = Me.Site
        Return rpt
    End Function
