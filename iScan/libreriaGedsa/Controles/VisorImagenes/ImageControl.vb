...
Namespace Controles
    Namespace VisorImagenes
        ...
        Public Class ImageControl
            ...
            Public Event control_KeyDowm(ByVal e As System.Windows.Forms.KeyEventArgs)
...
#Region "Public/Private Shadows"
            ...
            Public Shadows Property PosicionScrollHorizontal() As Double
                Get
                    Return Me.HScrollBar1.Value
                End Get
                Set(ByVal Value As Double)
                    Me.HScrollBar1.Value = Value
                End Set
            End Property

            Public Shadows Property PosicionScrollVertical() As Double
                Get
                    Return Me.VScrollBar1.Value
                End Get
                Set(ByVal Value As Double)
                    Me.VScrollBar1.Value = Value
                End Set
            End Property
            ...
            Public Shadows Sub ponerAlMaximoScrollHorizontal()
                Me.HScrollBar1.Value = Me.HScrollBar1.Maximum
            End Sub

            Public Shadows Sub ponerAlMaximoScrollVertical()
...
#End Region
            ...
            Private Sub DrawingBoard1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles DrawingBoard1.KeyDown
                'MsgBox("DrawingBoard1_KeyDown:  " & e.KeyCode)
                RaiseEvent control_KeyDowm(e)
            End Sub
            ...
            Private Sub ImageControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
                'MsgBox(e.KeyCode)
